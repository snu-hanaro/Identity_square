...
public:
  ...
  virtual ICM_20948_Status_e begin(I2C_HandleTypeDef *i2cPort);
};
...
public:
  ...
  ICM_20948_Status_e begin(SPI_HandleTypeDef *spiPort, GPIO_TypeDef* gpioPort, uint16_t csPin, uint32_t SPIFreq = ICM_20948_SPI_DEFAULT_FREQ);
};
