 ...
 *      Author: shpar
 */
// icm20948의 dmp 설정은 매우 복잡하다.
// Sparkfun icm20948 라이브러리의 저자들은 dmp 라이브러리를 작성하기 위해 제조사 Invensense로부터 비공개 문서를 받았다고 한다(..).
// (https://github.com/sparkfun/SparkFun_ICM-20948_ArduinoLibrary/blob/main/DMP.md 참조)
// 현재 그 문서는 공개되어 있다.
// 동일 경로 application_note-programming_sequence_for_dmp_hw_functions_icm_20648.pdf 참조
// 하지만 위 문서를 전부 읽고 재작성하기는 어렵다. 다행히 Sparkfun 라이브러리 저자들은 dmp 초기화 함수를 overwrite할 수 있게 해놓았다.
// 이를 통해 복사해온 원본 함수에서 고쳐 사용할 수 있다.
// Identity^2 에서는 원본
