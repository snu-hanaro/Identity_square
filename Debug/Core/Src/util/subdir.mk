...
CPP_SRCS += \
../Core/Src/util/stm32_uart_stdio.cpp 

OBJS += \
./Core/Src/util/stm32_uart_stdio.o 

CPP_DEPS += \
./Core/Src/util/stm32_uart_stdio.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/util/%.o Core/Src/util/%.su Core/Src/util/%.cyclo: ../Core/Src/util/%.cpp Core/Src/util/subdir.mk
...
clean-Core-2f-Src-2f-util:
	-$(RM) ./Core/Src/util/stm32_uart_stdio.cyclo ./Core/Src/util/stm32_uart_stdio.d ./Core/Src/util/stm32_uart_stdio.o ./Core/Src/util/stm32_uart_stdio.su
